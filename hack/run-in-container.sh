...
DOCKER_LIB_VOLUME=${DOCKER_LIB_VOLUME:-benchmark-operator-docker-lib}
DOCKER_GRAPH_VOLUME=${DOCKER_GRAPH_VOLUME:-benchmark-operator-docker-graph}
DOCKER_GO_VOLUME=${DOCKER_GO_VOLUME:-benchmark-operator-go}
NAME=${NAME:-benchmark-operator-dev}
...
Environments:
    ...
    DOCKER_LIB_VOLUME   the name of docker lib volume, defaults: benchmark-operator-docker-lib
    DOCKER_GRAPH_VOLUME the name of docker graph volume, defaults: benchmark-operator-docker-graph
    DOCKER_GO_VOLUME    the name of go cache volume, defaults: benchmark-operator-go
...
docker run ${docker_args[@]} \
    -v $ROOT:/go/src/benchmark-operator \
    -w /go/src/benchmark-operator \
